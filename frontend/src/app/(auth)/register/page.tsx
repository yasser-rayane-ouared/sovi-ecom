          ...
          <CardContent className="p-6 pt-0 font-cairo">
            ...
            {isMock ? (
              <button
                ...
                className="w-full group relative flex items-center justify-center gap-3 px-6 py-3.5 rounded-full border border-amber-500/20 bg-[#0e0f14] hover:bg-[#161822] text-white font-extrabold text-sm transition-all duration-300 shadow-lg shadow-amber-500/5 hover:shadow-amber-500/10 hover:border-amber-500/40 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md"
              >
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-amber-500/10 via-transparent to-yellow-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                ...
                <span className="relative z-10 text-slate-100 font-outfit tracking-wide">التسجيل بواسطة Google</span>
              </button>
            ) : (
