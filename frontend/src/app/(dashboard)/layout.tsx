    ...
    initialize().then(() => {
      ...
      api.get("/stores/").then((res) => {
        ...
        if (storeList.length > 0) {
          ...
          const mainStoreWithOrders = storeList.find((s: any) => s.subdomain === 'mc' || s.subdomain === 'privilegia-dz' || s.subdomain === 'fakhama' || s.subdomain === 'akrm' || s.subdomain === 'yassooo') || storeList[0];
          if (!currentSelected) {
