...
class ProductDuplicateView(APIView):
    ...
    def post(self, request, store_id, product_id):
        ...
        new_product = Product.objects.create(
            ...
            confirmation_cost=old_product.confirmation_cost,
            packaging_cost=old_product.packaging_cost,
            return_cost=old_product.return_cost,
            other_costs=old_product.other_costs,
